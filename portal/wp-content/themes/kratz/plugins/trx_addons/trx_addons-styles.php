...
if ( ! function_exists( 'kratz_trx_addons_add_theme_vars' ) ) {
	add_filter( 'kratz_filter_add_theme_vars', 'kratz_trx_addons_add_theme_vars', 10, 2 );
	function kratz_trx_addons_add_theme_vars( $rez, $vars ) {
...
if ( ! function_exists( 'kratz_trx_addons_get_css' ) ) {
	add_filter( 'kratz_filter_get_css', 'kratz_trx_addons_get_css', 10, 2 );
	function kratz_trx_addons_get_css( $css, $args ) {
...
.sc_services_timeline .sc_services_item_timeline:before{
...
.related_wrap.sc_services_default .sc_services_item_title{
    {$fonts['h5_font-size']}
...
/* User styles
------------------------------------------ */
.sc_button:hover .sc_button_icon>span{
...
.slider_outer_controls_side .slider_controls_wrap > a {
	color: {$colors['text_dark']};
	background-color: {$colors['extra_dark_06']} !important;
}
...
.swiper-pagination-custom .swiper-pagination-button {
	border-color: {$colors['alter_link_04']};
...
.portfolio_page_details_share .social_item:hover, 
.portfolio_page_details_share .social_item:hover{
    background-color: {$colors['alter_link']};
}
.portfolio_page_details_share .social_item:hover .social_icon, 
.portfolio_page_details_share .social_item:hover .social_icon i{
    color: {$colors['text_link4']} !important;
}

.portfolio_page_details_top  .portfolio_page_details_share .socials_wrap .social_item{
     background-color: {$colors['text_link']};
}
.portfolio_page_details_top  .portfolio_page_details_share .socials_wrap .social_item:hover{
      background-color: {$colors['alter_link']};
}
...
.sc_promo_text .sc_item_subtitle{
    color:{$colors['alter_link3']};
}
...
.sc_services_timeline .sc_services_item_title a:hover{
    color: {$colors['extra_link']};
}
.sc_services_timeline .sc_button.sc_button_simple:hover {
...
.sc_services_timeline .sc_services_item .sc_services_item_timeline:after,
.sc_services_timeline .sc_services_item:nth-child(even) .sc_services_item_info .sc_services_item_header:before,
.sc_services_timeline .sc_services_item .sc_services_item_info .sc_services_item_header:after{
    color: {$colors['alter_dark']};
}


.sc_services_timeline .sc_services_item_featured_top.with_number .sc_services_item_timeline:after,
.sc_services_timeline .sc_services_item_featured_top.with_number .sc_services_item_timeline:before{
    color: {$colors['text_04']};
}
.scheme_dark .sc_services_timeline .sc_services_item_featured_top.with_number .sc_services_item_timeline:after,
.scheme_dark .sc_services_timeline .sc_services_item_featured_top.with_number .sc_services_item_timeline:before{
    color: {$colors['bg_color_02']};
}

.sc_services_timeline .sc_services_item_featured_top.with_number .sc_services_item_marker{
    color: {$colors['text_link']};
}
.scheme_dark .sc_services_timeline .sc_services_item_featured_top.with_number .sc_services_item_marker{
    color: {$colors['alter_link']};
}
...
.sc_services_hover .trx_addons_columns_wrap.no_margin > [class*="trx_addons_column-"] .sc_services_item.with_image .sc_services_item_header:before, 
.sc_services_hover .trx_addons_columns_wrap.no_margin > [class*="trx_addons_column-"] .sc_services_item.with_image .sc_services_item_content:before{
     background-color: {$colors['alter_bg_color_09']};
}
.sc_services_hover .trx_addons_columns_wrap.no_margin > [class*="trx_addons_column-"]:nth-child(even) .sc_services_item.with_image .sc_services_item_header:before, 
.sc_services_hover .trx_addons_columns_wrap.no_margin > [class*="trx_addons_column-"]:nth-child(even) .sc_services_item.with_image .sc_services_item_content:before{
     background-color: {$colors['text_link_09']};
}

.sc_services_hover .trx_addons_columns_wrap.no_margin > [class*="trx_addons_column-"]:nth-child(even) .sc_services_item.with_image .sc_services_item_content .sc_services_item_text{
     color: {$colors['alter_dark']};
}
...
.scheme_dark .sc_services .sc_button.sc_button_simple{
     color: {$colors['alter_link']};
}
...
.sc_services_light .sc_button.sc_button_simple{
    color: {$colors['alter_link']};
}
.sc_services_light .sc_button.sc_button_simple:hover{
...
.sc_services_timeline .sc_services_item .sc_services_item_timeline:before{
    color: {$colors['text_dark']};
    border-color: {$colors['text_link']};
	background-color: {$colors['bg_color']};
}
...
.sc_layouts_menu_mobile_button_burger .sc_layouts_item_icon:after{
    background-color: {$colors['alter_bg_color_02']};
}
.header_position_default .sc_layouts_menu_mobile_button:hover .sc_layouts_item_icon:before,
 .header_position_default .sc_layouts_menu_mobile_button_burger:hover .sc_layouts_item_icon:before{
    color: {$colors['text_link']};
}
.sc_layouts_menu_mobile_button:hover .sc_layouts_item_icon:after, 
.sc_layouts_menu_mobile_button_burger:hover .sc_layouts_item_icon:after{
    background-color: {$colors['text_link']};
}
