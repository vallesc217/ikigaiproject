...
if ( ! function_exists( 'kratz_date_time_picker_field_get_css' ) ) {
	add_filter( 'kratz_filter_get_css', 'kratz_date_time_picker_field_get_css', 10, 2 );
	function kratz_date_time_picker_field_get_css( $css, $args ) {
