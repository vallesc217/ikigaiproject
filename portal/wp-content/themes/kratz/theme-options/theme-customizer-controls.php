...
// 'info' field
//--------------------------------------------------------------------
class Kratz_Customize_Info_Control extends WP_Customize_Control {
	public $type = 'info';
...
// 'hidden' field
//--------------------------------------------------------------------
class Kratz_Customize_Hidden_Control extends WP_Customize_Control {
	public $type = 'hidden';
	...
	public function render_content() {
		...
		if ( 'last_option' == $this->id && kratz_storage_get( 'need_footer_scripts', false ) ) {
			kratz_storage_set( 'need_footer_scripts', false );
...
// 'button' field
//--------------------------------------------------------------------
class Kratz_Customize_Button_Control extends WP_Customize_Control {
	public $type = 'button';
...
// 'switch' field
//--------------------------------------------------------------------
class Kratz_Customize_Switch_Control extends WP_Customize_Control {
	public $type = 'switch';
...
// 'icon' field
//--------------------------------------------------------------------
class Kratz_Customize_Icon_Control extends WP_Customize_Control {
	public $type = 'icon';
...
// 'checklist' field
//--------------------------------------------------------------------
class Kratz_Customize_Checklist_Control extends WP_Customize_Control {
...
// 'scheme_editor' field
//--------------------------------------------------------------------
class Kratz_Customize_Scheme_Editor_Control extends WP_Customize_Control {
			...
			/>
				...
				kratz_show_layout(
					kratz_show_custom_field(
						...
						$this->input_attrs,
						kratz_unserialize( $this->input_attrs['value'] )
					)
				);
				?>
			</span>
...
// 'text_editor' field
//--------------------------------------------------------------------
class Kratz_Customize_Text_Editor_Control extends WP_Customize_Control {
	...
	public function render_content() {
		...
		kratz_storage_set( 'need_footer_scripts', true );
	}
}
...
// 'range' field
//--------------------------------------------------------------------
class Kratz_Customize_Range_Control extends WP_Customize_Control {
	public $type = 'range';
	...
	public function render_content() {
		...
		<div class="customize-control-wrap">
			...
			<span class="customize-control-field-wrap"><input type="<?php echo ! $show_value ? 'hidden' : 'text'; ?>" 
				...
				$this->link();
				if ( $show_value ) {
					echo ' class="kratz_range_slider_value"';
				}
				if ( ! empty( $this->input_attrs['var_name'] ) ) {
					echo ' data-var_name="' . esc_attr( $this->input_attrs['var_name'] ) . '"';
				}
