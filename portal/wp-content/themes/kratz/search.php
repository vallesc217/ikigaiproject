...
// Search page setup
// (uncomment lines with kratz_storage_set_array2() calls if you want to override the relevant settings from Theme Options)
...
kratz_storage_set_array( 'options_meta', 'blog_style', 'masonry_3' );

// Sidebar position:
// Replace last parameter with one of values: none | left | right
kratz_storage_set_array( 'options_meta', 'sidebar_position', 'none' );
