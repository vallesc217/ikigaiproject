...
Please install and activate it before starting to use the theme Kratz.
...
Theme documentation is available on http://kratz.themerex.net/doc/
...
2) Icons (css/font-icons/*.*)
   The icon set used in Kratz is Fontello.
