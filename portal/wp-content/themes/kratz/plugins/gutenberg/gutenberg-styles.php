...
if ( ! function_exists( 'kratz_gutenberg_add_theme_vars' ) ) {
	add_filter( 'kratz_filter_add_theme_vars', 'kratz_gutenberg_add_theme_vars', 10, 2 );
	function kratz_gutenberg_add_theme_vars( $rez, $vars ) {
		return $rez;
	}
}
...
if ( ! function_exists( 'kratz_gutenberg_get_css' ) ) {
	add_filter( 'kratz_filter_get_css', 'kratz_gutenberg_get_css', 10, 2 );
	function kratz_gutenberg_get_css( $css, $args ) {
